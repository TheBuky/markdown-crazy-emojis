...
-----
    >>> import requests
    >>> from webpagefx import EMOJIS, BASE_URL
...
-----
    ...
    >>> import markdown
    >>> html = markdown.markdown(src, extensions=['markdown-crazy-emojis'], extension_configs = {'markdown-crazy-emojis': { 'kind_emojis' : 'github'} })
    >>> print(html)
    <p><img class="emoji" src="https://assets-cdn.github.com/images/icons/emoji/open_mouth.png" /></p>
