...
===================================================
Based on https://www.webpagefx.com/tools/emoji-cheat-sheet/

Query
-----
    >>> import requests
    >>> from bs4 import BeautifulSoup
    >>> soup =  BeautifulSoup(requests.get('https://www.webpagefx.com/tools/emoji-cheat-sheet/', verify=False).text)
    >>> elements = soup.find(class_='emojis').find_all('li')
    >>> for element in elements:
    >>>      print("'" + element.find(class_="name").text + "': '" + element.find(class_="emoji")['data-src']+ "',")
...
-----
    ...
    >>> import markdown
    >>> html = markdown.markdown(src, extensions=['markdown-crazy-emojis'], extension_configs = {'markdown-crazy-emojis': { 'kind_emojis' : 'webpagefx'} })
    >>> print(html)
    <p><img class="emoji" alt="open_mouth" src="https://www.webpagefx.com/tools/emoji-cheat-sheet/graphics/emojis/open_mouth.png" /></p>
...
BASE_URL = 'https://www.webpagefx.com/tools/emoji-cheat-sheet/graphics/emojis/'
